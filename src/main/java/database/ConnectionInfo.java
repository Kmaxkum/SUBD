    ...
    public SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                configuration.addAnnotatedClass(AdsBoard.class);
                configuration.addAnnotatedClass(ListOfAds.class);
                configuration.addAnnotatedClass(ListOfAdsAds.class);
                configuration.addAnnotatedClass(Ads.class);
                configuration.addAnnotatedClass(Status.class);
                configuration.addAnnotatedClass(Applicant.class);
                configuration.addAnnotatedClass(Responded.class);
                configuration.addAnnotatedClass(RespondedAds.class);
